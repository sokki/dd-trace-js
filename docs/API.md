...
| sampleRate      | `DD_TRACE_SAMPLE_RATE`            | `1`            | Controls the ingestion sample rate (between 0 and 1) between the agent and the backend. Defaults to deferring the decision to the agent. |
